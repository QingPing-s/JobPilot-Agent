...
![UI界面](docs/images/UI.png)

## 系统架构

![JobPilot RAG-Agent 系统架构图](docs/images/JobPilot.png)


## 核心功能

- 候选人画像读取，支持 Markdown、PDF、DOCX、文本和图片简历解析
- 扫描型 PDF 与图片使用 RapidOCR，文本型 PDF 和 Word 文档本地直接提取
